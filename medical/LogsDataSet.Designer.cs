...
namespace medical {
    ...
    public partial class LogsDataSet : global::System.Data.DataSet {
        ...
        public partial class LogDataTable : global::System.Data.TypedTableBase<LogRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public LogRow AddLogRow(string AccessTime, string User) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public LogRow FindByAccessTime(string AccessTime) {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new global::System.Data.UniqueConstraint("Constraint1", new global::System.Data.DataColumn[] {
                                this.columnAccessTime}, true));
                this.columnAccessTime.AllowDBNull = false;
                this.columnAccessTime.Unique = true;
        ...
        public partial class LogRow : global::System.Data.DataRow {
            ...
            public string AccessTime {
                get {
                    return ((string)(this[this.tableLog.AccessTimeColumn]));
                }
                set {
                    this[this.tableLog.AccessTimeColumn] = value;
                }
            }
...
namespace medical.LogsDataSetTableAdapters {
    ...
    public partial class LogTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Log` WHERE ((`AccessTime` = ?) AND ((? = 1 AND `User` IS NULL) OR (`" +
                "User` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Log` (`AccessTime`, `User`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Log` SET `AccessTime` = ?, `User` = ? WHERE ((`AccessTime` = ?) AND ((? =" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::medical.Properties.Settings.Default.LogsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT AccessTime, [User] FROM Log";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO `Log` (`AccessTime`, `User`) VALUES (?, ?)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("AccessTime", global::System.Data.OleDb.OleDbType.WChar, 255, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "AccessTime", global::System.Data.DataRowVersion.Current, false, null));
        ...
        public virtual int Fill(LogsDataSet.LogDataTable dataTable) {
        ...
        public virtual LogsDataSet.LogDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LogsDataSet.LogDataTable dataTable = new LogsDataSet.LogDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LogsDataSet.LogDataTable dataTable) {
        ...
        public virtual int Delete(string Original_AccessTime, string Original_User) {
            if ((Original_AccessTime == null)) {
                throw new global::System.ArgumentNullException("Original_AccessTime");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[0].Value = ((string)(Original_AccessTime));
            }
        ...
        public virtual int Insert(string AccessTime, string User) {
            if ((AccessTime == null)) {
                throw new global::System.ArgumentNullException("AccessTime");
            }
            else {
                this.Adapter.InsertCommand.Parameters[0].Value = ((string)(AccessTime));
            }
            if ((User == null)) {
        ...
        public virtual int Update(string AccessTime, string User, string Original_AccessTime, string Original_User) {
            if ((AccessTime == null)) {
                throw new global::System.ArgumentNullException("AccessTime");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[0].Value = ((string)(AccessTime));
            }
            if ((User == null)) {
            ...
            if ((Original_AccessTime == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_AccessTime));
            }
            if ((Original_User == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string User, string Original_AccessTime, string Original_User) {
            return this.Update(Original_AccessTime, User, Original_AccessTime, Original_User);
        }
        ...
        public virtual int InsertQuery(string AccessTime, string User) {
            global::System.Data.OleDb.OleDbCommand command = this.CommandCollection[1];
            if ((AccessTime == null)) {
                throw new global::System.ArgumentNullException("AccessTime");
            }
            else {
                command.Parameters[0].Value = ((string)(AccessTime));
            }
            if ((User == null)) {
